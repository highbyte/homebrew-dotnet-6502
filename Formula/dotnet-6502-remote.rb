class Dotnet6502Remote < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "106d43024e316d486bee4d35f5f619e1549cbcf7c2b7ceb0793c5e50f475465a"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "ae42d53f3ef1c924ebf9bd5803f49b179108b9109140873072654c6123b58de7"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-RemoteClient-linux-arm64.zip"
      sha256 "d73d3c29e1f0871bbf8ddfc8d68b9e7384e46a8e5b17697180cfb4509d5204ef"
    end
  end
