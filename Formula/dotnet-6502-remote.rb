class Dotnet6502Remote < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "5e1757cf0285e81a5281d36805a4e57ed7225e4cf75937b33e01b48f6f73762c"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "452fe98cd773dbde22241ce0cb9aa86eedd0382d8f5a6c65ff388c580a13321d"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-RemoteClient-linux-arm64.zip"
      sha256 "14b5377b9b4784e6333345d99741574ce2fa33c8c426032e699458a68772d1cd"
    end
  end
