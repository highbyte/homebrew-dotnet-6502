class Dotnet6502Remote < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "68a71da6ae7f3d2706afda1d2126fdc34c4a5d55d29e62b2e6cd17c274ba4f42"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "7e781aadc069e49bfba45499a110d3f8035109266dc4fec1428dcff3f8b354c0"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-RemoteClient-linux-arm64.zip"
      sha256 "c09d6da629dfb0ec7eb4250881561f8619bea77172fa77d63ce4e0949cdc10e4"
    end
  end
