class Dotnet6502Remote < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "30d76534e9081c2fe810e9852e690b3990d4cf39cb22db66419c077ee7ada421"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "abbebd12e9ef208249fb66e5b6946c9f2a8efefe1d11b15479b1a43eecbd770e"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-RemoteClient-linux-arm64.zip"
      sha256 "aa15b953a6e94e0b6475260973730e756c4c72019bb6502a66ebfb570aa58482"
    end
  end
