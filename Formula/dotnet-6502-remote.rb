class Dotnet6502Remote < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "7b344d91d5e75cd1f1560c3c743a5500868ba62f72cd0d373966febf7309d3b2"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "d1183a80c303a0b947b33a424c12c2d0141358cc59c767e1fce6ef63d7b1d6b3"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-RemoteClient-linux-arm64.zip"
      sha256 "4b84d278d27a5a8888173004dd1e6bfd7ce66c11cfaf3ab921d1ea482614e720"
    end
  end
