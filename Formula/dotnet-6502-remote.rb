class Dotnet6502Remote < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "16279531b78f859e72c59383db6c136dcbcf3a87cbac5f706d6faba33d062193"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "28487f7b15bf441c75c29abf0c8f4f8dcda855fbc34c64524e81876907d51283"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-RemoteClient-linux-arm64.zip"
      sha256 "a8109d2f82c1654d6e1f978977da86e45e81870ee5be8757668f2bb7f055ddd7"
    end
  end
