class Dotnet6502Terminal < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "4e0647c8b25c7d3ef623663e7b38f738cade128dee752a4a95df05077222c547"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "a26ecc1ef0fa49545c0274ffb338ac271e44effae55cf238709c4709197039bc"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-Terminal-linux-arm64.zip"
      sha256 "0dbba90730b4a565a00dc7deb3b7faa6fcb1d85309390b10de7aee94f73596dc"
    end
  end
