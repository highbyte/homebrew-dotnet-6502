class Dotnet6502Terminal < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "3e423c892251403178debfce25f837eba4751f2bd3aac5873f010d9b532871c8"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "7956b3fea7c842dc329c56acafc2ffa9405f114ffd4fc32242df567bd7417ed9"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-Terminal-linux-arm64.zip"
      sha256 "949c108e6c71ad569fcb0c15d069982ae07272044a472b5f97a7c56574b30dee"
    end
  end
