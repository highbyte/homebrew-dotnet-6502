class Dotnet6502Terminal < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "2a7fd96b39534fd9aacfd8053f8ef294d7bc300766312692b8d5793398f1ea9d"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "e2c36e7f003cdedd99fa6331ec3ae15d812ed4015a2b91ff8494874bcc96d11d"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-Terminal-linux-arm64.zip"
      sha256 "c54f2f72086543f9912126c055301306095a2e163747cf0ab7616fdfde9b52b8"
    end
  end
