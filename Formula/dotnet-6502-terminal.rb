class Dotnet6502Terminal < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "46f0b745e6b7422f83afb278628f75aa6fd5e81bfd861e2ca3b8c512a330ff6e"
    end
  end
  ...
  on_linux do
    on_intel do
      ...
      sha256 "2bd9ef2326651940d59153adc7998d4478cd3182778de44c7d9b6a797f35a1ef"
    end
    on_arm do
      url "https://github.com/highbyte/dotnet-6502/releases/download/v#{version}/DotNet6502-Terminal-linux-arm64.zip"
      sha256 "a8f3eee0c3bef9d0003242a4e12bfcca9a102a46dd7758025d20a323f524677c"
    end
  end
